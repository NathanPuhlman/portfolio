/*
Note from Nathan:
I feel like it's understandable to not be required to implement perlin noise
myself, that seems a bit out of the scope of this class. :) Not to mention the
benefit is well worth it. This code is found at
https://gist.github.com/KdotJPG/b1270127455a94ac5d19 and is released under the
Creative Commons License, so it ~should~ be completely legal to copy paste it into
my project, as long as I say that ANY CODE AFTER THIS COMMENT BLOCK WAS NOT
DESIGNED BY ME. IT WAS DESIGNED BY THE USER K.jpg ON GITHUB.
*/
